...
var census_grouped_variables = {
  ...
  'Census Name': [
    ...
    { name: 'Sub District Head Quarter (Dist in km)' },
    { name: 'District Head Quarter ' },
    { name: 'District Head Quarter  (Dist in km)' },
    { name: 'Nearest Statutory Town ' },
    { name: 'Nearest Statutory Town (Dist in km)' }
  ],
  'Land Use': [
    { name: 'Total Geographical Area (in Hectares)' },
    { name: 'Forests (in Hectares)' },
    { name: 'Non-Agricultural Uses (in Hectares)' },
    { name: 'Barren & Un-cultifvable Land (in Hectares)' },
    { name: 'Permanent Pastures/Grazing Land (in Hectares)' },
    { name: 'Land Under Misc Tree Crops etc. (in Hectares)' },
    { name: 'Culturable Waste Land (in Hectares)' },
    { name: 'Other Fallow Land (in Hectares)' },
    { name: 'Current Fallows (in Hectares)' },
    { name: 'Net Area Sown (in Hectares)' }
  ],
  Demographic: [
    { name: 'Total Households' },
    { name: 'Total Population of Village' },
    { name: 'Total Male Population of Village' },
    { name: 'Total Female Population of Village' },
    { name: 'Total Scheduled Castes Population of Village' },
    { name: 'Total Scheduled Castes  Male Population of Village' },
    { name: 'Total Scheduled Castes  Female Population of Village' },
    { name: 'Total Scheduled Tribes Population of Village' },
    { name: 'Total Scheduled Tribes  Male Population of Village' },
    { name: 'Total Scheduled Tribes  Female Population of Village' }
  ],
  'Edu-School': [
    { name: 'Govt Pre-Primary School (Nursery/LKG/UKG)' },
    { name: 'Govt  Pre - Primary School (Nursery/LKG/UKG) (Numbers)' },
    { name: 'Private Pre - Primary School (Nursery/LKG/UKG)' },
    { name: 'Private Pre - Primary School (Nursery/LKG/UKG) (Numbers)' },
    { name: 'Govt Primary School' },
    { name: 'Govt Primary School (Numbers)' },
    { name: 'Private Primary School' },
    { name: 'Private  Primary School (Numbers)' },
    { name: 'Govt Middle  School' },
    { name: 'Govt  Middle School (Numbers)' },
    { name: 'Private Middle  School' },
    { name: 'Private Middle School (Numbers)' },
    { name: 'Govt Secondary School' },
    { name: 'Govt  Secondary School (Numbers)' },
    { name: 'Private Secondary School' },
    { name: 'Private Secondary  School (Numbers)' },
    { name: 'Govt Senior Secondary School' },
    { name: 'Govt Senior Secondary School (Numbers)' },
    { name: 'Private Senior Secondary School' },
    { name: 'Private Senior Secondary  School (Numbers)' },
    { name: 'Government School For Disabled' },
    { name: 'Government School For Disabled (Numbers)' },
    { name: 'Private School For Disabled' },
    { name: 'Private School For Disabled (Numbers)' },
    { name: 'Government Others' },
    { name: 'Government Others (Numbers)' },
    { name: 'Private Others' },
    { name: 'Private Others (Numbers)' }
  ],
  'Edu-College': [
    { name: 'Govt  Arts and Science Degree College' },
    { name: 'Govt  Arts and Science Degree College (Numbers)' },
    { name: 'Private  Arts and Science Degree College' },
    { name: 'Private  Arts and Science Degree College (Numbers)' },
    { name: 'Govt Engineering College' },
    { name: 'Govt Engineering College (Numbers)' },
    { name: 'Private Engineering College' },
    { name: 'Private Engineering College (Numbers)' },
    { name: 'Govt Medicine College' },
    { name: 'Govt Medicine  College (Numbers)' },
    { name: 'Private Medicine  College' },
    { name: 'Private Medicine College (Numbers)' },
    { name: 'Govt Management Institute' },
    { name: 'Govt Management Institute (Numbers)' },
    { name: 'Private Management Institute' },
    { name: 'Private Management Institute (Numbers)' },
    { name: 'Govt Polytechnic' },
    { name: 'Govt Polytechnic (Numbers)' },
    { name: 'Private Polytechnic' },
    { name: 'Private Polytechnic (Numbers)' },
    { name: 'Govt Vocational Training School/ITI' },
    { name: 'Govt Vocational Training School/ITI (Numbers)' },
    { name: 'Private Vocational Training School/ITI' },
    { name: 'Private Vocational Training School/ITI (Numbers)' },
    { name: 'Government Non Formal Training Centre' },
    { name: 'Government Non Formal Training Centre (Numbers)' },
    { name: 'Private Non Formal Training Centre' },
    { name: 'Private Non Formal Training Centre (Numbers)' }
  ],
  Health: [
    { name: 'Community Health Centre' },
    { name: 'Community Health Centre Doctors Total Strength' },
    { name: 'Community Health Centre Doctors In Position' },
    { name: 'Community Health Centre Para Medical  Staff Total Strength' },
    { name: 'Community Health Centre Para Medical Staff In Position' },
    { name: 'Primary Health Centre' },
    { name: 'Primary Health Centre  Doctors Total Strength' },
    { name: 'Primary Health  Centre Doctors In Position' },
    { name: 'Primary  Health Centre Para Medical  Staff Total Strength' },
    { name: 'Primary  Health Centre Para Medical Staff In Position' },
    { name: 'Primary Heallth Sub Centre' },
    { name: 'Primary Heallth Sub Centre Doctors Total Strength' },
    { name: 'Primary Heallth Sub Centre Doctors In Position' },
    { name: 'Primary Heallth Sub Centre Para Medical  Staff Total Strength' },
    { name: 'Primary Heallth Sub Centre Para Medical Staff In Position' },
    { name: 'Maternity And Child Welfare Centre' },
    { name: 'Maternity And Child Welfare Centre Doctors Total Strength' },
    { name: 'Maternity And Child Welfare Centre Doctors In Position' },
    {
      name:
        'Maternity And Child Welfare Centre Para Medical  Staff Total Strength'
    },
    {
      name: 'Maternity And Child Welfare Centre Para Medical Staff In Position'
    },
    { name: 'TB Clinic' },
    { name: 'TB Clinic Doctors Total Strength' },
    { name: 'TB Clinic Doctors In Position' },
    { name: 'TB Clinic Para Medical Para Medical  Staff Total Strength' },
    { name: 'TB Clinic Para Medical Para Medical Staff In Position' },
    { name: 'Hospital Allopathic' },
    { name: 'Hospital Allopathic Doctors Total Strength' },
    { name: 'Hospital Allopathic Doctors In Position' },
    { name: 'Hospital Allopathic Para Medical  Staff Total Strength' },
    { name: 'Hospital Allopathic Para Medical Staff In Position' },
    { name: 'Hospiltal Alternative Medicine' },
    { name: 'Hospiltal Alternative Medicine Doctors Total Strength' },
    { name: 'Hospiltal Alternative Medicine Doctors In Position' },
    {
      name: 'Hospiltal Alternative Medicine Para Medical  Staff Total Strength'
    },
    { name: 'Hospiltal Alternative Medicine Para Medical Staff In Position' },
    { name: 'Dispensary' },
    { name: 'Dispensary Doctors Total Strength' },
    { name: 'Dispensary Doctors In Position' },
    { name: 'Dispensary Para Medical  Staff Total Strength' },
    { name: 'Dispensary Para Medical Staff In Position' },
    { name: 'Veterinary Hospital' },
    { name: 'Veterinary Hospital Doctors Total Strength' },
    { name: 'Veterinary Hospital Doctors In Position' },
    { name: 'Veterinary Hospital Para Medical  Staff Total Strength' },
    { name: 'Veterinary Hospital Para Medical Staff In Position' },
    { name: 'Mobile Health Clinic' },
    { name: 'Mobile Health Clinic Doctors Total Strength' },
    { name: 'Mobile Health Clinic Doctors In Position' },
    { name: 'Mobile Health Clinic Para Medical  Staff Total Strength' },
    { name: 'Mobile Health Clinic Para Medical Staff In Position(Numbers)' },
    { name: 'Family Welfare Centre' },
    { name: 'Family Welfare Centre Doctors Total Strength' },
    { name: 'Family Welfare Centre Doctors In Position' },
    { name: 'Family Welfare Centre Para Medical  Staff Total Strength' },
    { name: 'Family Welfare Centre Para Medical Staff In Position' },
    { name: 'Non Govt Med facilities Out Patient' },
    { name: 'Non Govt Med facilities In And Out Patient' },
    { name: 'Non Govt Med facilities Charitable' },
    { name: 'Non Govt Med facilities Medical Prctitioner with MBBS Degree' },
    { name: 'Non Govt Med facilities Medical Prctitioner with other Degree' },
    { name: 'Non Govt Med facilities Medical Practitioner with no  Degree' },
    {
      name: 'Non Govt Med facilities Traditional Practitioner and Faith  Healer'
    },
    { name: 'Non Govt Med facilities Medicine Shop' },
    { name: 'Non Govt Med facilities Others' },
    { name: 'ASHA' }
  ],
  Water: [
    { name: 'Tap Water-Treated' },
    { name: 'Tap Water-Treated (Functions all year)' },
    { name: 'Tap Water-Treated (Functions in Summer, Apr-Sep)' },
    { name: 'Tap Water Untreated' },
    { name: 'Tap Water Untreated (Functions all year)' },
    { name: 'Tap Water Untreated (Functions in Summer, Apr-Sep)' },
    { name: 'Covered Well' },
    { name: 'Covered Well (Functions all year)' },
    { name: 'Covered Well (Functions in Summer, Apr-Sep)' },
    { name: 'Uncovered  Well' },
    { name: 'Uncovered  Well (Functions all year)' },
    { name: 'Uncovered  Well (Functions in Summer, Apr-Sep)' },
    { name: 'Hand Pump' },
    { name: 'Hand Pump (Functions all year)' },
    { name: 'Hand Pump (Functions in Summer, Apr-Sep)' },
    { name: 'Tube Wells/Bore' },
    { name: 'Tube Wells/Bore (Functions all year)' },
    { name: 'Tube Wells/Bore (Functions in Summer, Apr-Sep)' },
    { name: 'Spring' },
    { name: 'Spring (Functions all year)' },
    { name: 'Spring (Functions in Summer, Apr-Sep)' },
    { name: 'River/Canal' },
    { name: 'River/Canal (Functions all year)' },
    { name: 'River/Canal (Functions in Summer, Apr-Sep)' },
    { name: 'Tank/Pond/Lake' },
    { name: 'Tank/Pond/Lake (Functions all year)' },
    { name: 'Tank/Pond/Lake (Functions in Summer, Apr-Sep)' },
    { name: 'Others' },
    { name: 'Others (Functions all year)' },
    { name: 'Others (Functions in Summer, Apr-Sep)' }
  ],
  'Sanitation & Waste Mgmt': [
    { name: 'Closed Drainage' },
    { name: 'Open Drainage' },
    { name: 'No  Drainage' },
    { name: 'Open Pucca Drainage Covered with Tiles Slabs' },
    { name: 'Open Pucca Drainage Uncovered' },
    { name: 'Open Kuccha Drainage' },
    {
      name:
        'Whether Drain water is discharged directly into water bodies or to sewar plant (For Water Bodies-1/Sewar Plants-2)'
    },
    { name: 'Is the Area Covered under Total Sanitation Campaign (TSC)?' },
    { name: 'Community Toilet Complex (including Bath) for General Public' },
    { name: 'Community Toilet Complex (excluding Bath) for General Public' },
    {
      name:
        'Rural Production Centres or Sanitary hardware outlet availability near the village'
    },
    {
      name:
        'Rural Production mart or Sanitary hardware outlet availability near the village'
    },
    { name: 'Community waste disposal system after house to house collection' },
    { name: 'Community Bio-gas or recycle of waste for production use' },
    { name: 'No System (Garbage on road/street)' }
  ],
  Communication: [
    { name: 'Post Office' },
    { name: 'Sub Post Office' },
    { name: 'Post And Telegraph Office' },
    { name: 'Village Pin Code' },
    { name: 'PIN Code' },
    { name: 'Telephone (landlines)' },
    { name: 'Public Call Office /Mobile (PCO)' },
    { name: 'Mobile Phone Coverage' },
    { name: 'Internet Cafes / Common Service Centre (CSC)' },
    { name: 'Private Courier Facility' }
  ],
  Transport: [
    { name: 'Public Bus Service' },
    { name: 'Private Bus Service' },
    { name: 'Railway Station' },
    { name: 'Auto/Modified Autos' },
    { name: 'Taxi ' },
    { name: 'Vans' },
    { name: 'Tractors' },
    { name: 'Cycle-pulled Rickshaws   (manual driven)' },
    { name: 'Cycle-pulled Rickshaws (machine driven)' },
    { name: 'Carts Drivens by Animals' },
    { name: 'Sea/River/Ferry Service' },
    { name: 'National Highway' },
    { name: 'State Highway' },
    { name: 'Major District Road' },
    { name: 'Other District Road' },
    { name: 'Black Topped (pucca) Road' },
    { name: 'Gravel (kuchha) Roads' },
    { name: 'Water Bounded Macadam' },
    { name: 'All Weather Road' },
    { name: 'Navigable Waterways (River/Canal)' },
    { name: 'Foothpath' }
  ],
  Finance: [
    { name: 'ATM' },
    ...
    { name: 'Agricultural Credit Societies' },
    { name: 'Self - Help Group (SHG)' }
  ],
  Nutrition: [
    { name: 'Public Distribution System (PDS) Shop' },
    { name: 'Nutritional Centres-ICDS' },
    { name: 'Nutritional Centres-Anganwadi Centre' },
    { name: 'Nutritional Centres-Others' }
  ],
  Agriculture: [
    { name: 'Mandis/Regular Market' },
    { name: 'Agricultural Marketing Society' },
    { name: 'Agricultural Commodities (First)' },
    { name: 'Agricultural Commodities (Second)' },
    { name: 'Agricultural Commodities (Third)' }
  ],
  Commerce: [
    { name: 'Weekly Haat' },
    { name: 'Manufacturers Commodities (First)' },
    { name: 'Handicrafts Commodities (First)' },
    { name: 'Manufacturers Commodities (Second)' },
    { name: 'Handicrafts Commodities (Second)' },
    { name: 'Manufacturers Commodities (Third)' },
    { name: 'Handicrafts  Commodities (Third)' }
  ],
  'Other Facilities': [
    { name: 'Community Centre with/without TV' },
    { name: 'Sports Field' },
    { name: 'Sports Club/Recreation Centre' },
    { name: 'Cinema/Video Hall' },
    { name: 'Public Library' },
    { name: 'Public Reading Room' },
    { name: 'Daily Newspaper Supply' },
    { name: 'Assembly Polling Station' },
    { name: 'Birth and Death Registration Office' }
  ],
  Energy: [
    { name: 'Power Supply (Domestic)' },
    { name: 'Power Supply (Domestic) (Apr-Sep) (hrs/day)' },
    { name: 'Power Supply (Domestic) (Oct-Mar) (hrs/day)' },
    { name: 'Power Supply (Agriculture)' },
    { name: 'Power Supply (Agriculture) (Apr-Sep) (hrs/day)' },
    { name: 'Power Supply (Agriculture) (Oct-Mar) (hrs/day)' },
    { name: 'Power Supply (Commercial)' },
    { name: 'Power Supply (Commercial) (Apr-Sep) (hrs/day)' },
    { name: 'Power Supply (Commercial) (Oct-Mar) (hrs/day)' },
    { name: 'Power Supply All Users' },
    { name: 'Power Supply All Users (Apr-Sep) (hrs/day)' },
    { name: 'Power Supply All Users (Oct-Mar) (hrs/day)' }
  ],
  Irrigation: [
    { name: 'Total Unirrigated Land (in Hectares)' },
    { name: 'Total Irrigated Land (in Hectares)' },
    { name: 'by Canals (in Hectares)' },
    { name: 'by Wells/Tube Wells (in Hectares)' },
    { name: 'by Tanks/Lakes (in Hectares)' },
    { name: 'by Waterfall (in Hectares)' },
    { name: 'by Other Source (in Hectares)' }
  ]
};
...
var fields_short_long_map = {
  ...
  'Total Scheduled Castes  Male Population':
    'Total.Scheduled.Castes..Male.Population.of.Village',
  'Total Scheduled Castes  Female Population':
  ...
  'Total Scheduled Tribes  Male Population':
    'Total.Scheduled.Tribes..Male.Population.of.Village',
  'Total Scheduled Tribes  Female Population':
    'Total.Scheduled.Tribes..Female.Population.of.Village',
  'Govt Pre-Primary School (Nursery/LKG/UKG)':
    'Govt.Pre-Primary.School..Nursery.LKG.UKG...Status.A.1..NA.2..',
  ...
  'Private Senior Secondary  School (Numbers)':
    'Private.Senior.Secondary..School..Numbers.',
  'Govt  Arts and Science Degree College':
    'Govt..Arts.and.Science.Degree.College..Status.A.1..NA.2..',
  'Govt  Arts and Science Degree College (Numbers)':
    'Govt..Arts.and.Science.Degree.College..Numbers.',
  'Private  Arts and Science Degree College':
    'Private..Arts.and.Science.Degree.College..Status.A.1..NA.2..',
  ...
  'Govt Vocational Training School/ITI':
    'Govt.Vocational.Training.School.ITI..Status.A.1..NA.2..',
  ...
  'Community Health Centre Doctors Total Strength':
  ...
  'Community Health Centre Para Medical  Staff Total Strength':
    'Community.Health.Centre.Para.Medical..Staff.Total.Strength..Numbers.',
  'Community Health Centre Para Medical Staff In Position':
  ...
  'Primary Health  Centre Doctors In Position':
    'Primary.Health..Centre.Doctors.In.Position..Numbers.',
  'Primary  Health Centre Para Medical  Staff Total Strength':
    'Primary..Health.Centre.Para.Medical..Staff.Total.Strength..Numbers.',
  'Primary  Health Centre Para Medical Staff In Position':
  ...
  'Primary Heallth Sub Centre Doctors Total Strength':
    'Primary.Heallth.Sub.Centre.Doctors.Total.Strength..Numbers.',
  'Primary Heallth Sub Centre Doctors In Position':
    'Primary.Heallth.Sub.Centre.Doctors.In.Position..Numbers.',
  'Primary Heallth Sub Centre Para Medical  Staff Total Strength':
    'Primary.Heallth.Sub.Centre.Para.Medical..Staff.Total.Strength..Numbers.',
  'Primary Heallth Sub Centre Para Medical Staff In Position':
  ...
  'Maternity And Child Welfare Centre Doctors Total Strength':
    'Maternity.And.Child.Welfare.Centre.Doctors.Total.Strength..Numbers.',
  'Maternity And Child Welfare Centre Doctors In Position':
  ...
  'Whether Drain water is discharged directly into water bodies or to sewar plant (For Water Bodies-1/Sewar Plants-2)':
    'Whether.Drain.water.is.discharged.directly.into.water.bodies.or.to.sewar.plant..For.Water.Bodies-1.Sewar.Plants-2.',
  'Is the Area Covered under Total Sanitation Campaign (TSC)?':
    'Is.the.Area.Covered.under.Total.Sanitation.Campaign..TSC.?..Status.A.1..NA.2..',
  'Community Toilet Complex (including Bath) for General Public':
    'Community.Toilet.Complex..including.Bath..for.General.Public..Status.A.1..NA.2..',
  'Community Toilet Complex (excluding Bath) for General Public':
    'Community.Toilet.Complex..excluding.Bath..for.General.Public..Status.A.1..NA.2..',
  'Rural Production Centres or Sanitary hardware outlet availability near the village':
    'Rural.Production.Centres.or.Sanitary.hardware.outlet.availability.near.the.village..Status.A.1..NA.2..',
  'Rural Production mart or Sanitary hardware outlet availability near the village':
    'Rural.Production.mart.or.Sanitary.hardware.outlet.availability.near.the.village..Status.A.1..NA.2..',
  'Community waste disposal system after house to house collection':
    'Community.waste.disposal.system.after.house.to.house.collection..Status.A.1..NA.2..',
  'Community Bio-gas or recycle of waste for production use':
    'Community.Bio-gas.or.recycle.of.waste.for.production.use..Status.A.1..NA.2..',
  ...
  'Cycle-pulled Rickshaws   (manual driven)':
    'Cycle-pulled.Rickshaws....manual.driven...Status.A.1..NA.2..',
  'Cycle-pulled Rickshaws (machine driven)':
    'Cycle-pulled.Rickshaws..machine.driven...Status.A.1..NA.2..',
  ...
  'Navigable Waterways (River/Canal)':
    'Navigable.Waterways..River.Canal...Status.A.1..NA.2..',
  ...
  'Power Supply All Users (Apr-Sep) (hrs/day)':
    'Power.Supply.For.All.Users.Summer..April-Sept...per.day..in.Hours.',
  'Power Supply All Users (Oct-Mar) (hrs/day)':
  ...
  'Total Unirrigated Land (in Hectares)':
